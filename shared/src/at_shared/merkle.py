...
Shared between the api-gateway (which emits audit leaves and exports Merkle
proof bundles) and the audit-service batcher (which folds leaves into a batch
and submits the root to AuditAnchor.sol).
